...
FAMILIAS = {
    ...
    "Compra est NEC conf": "LBO,MMC,REV,MIN,FEC,ACE,FER,LAM,FND,EPM,EMB,DBR,AVI,PRF,COL,FNC,VPE,CST,MAN,ABR,ARM,RV,CRD,CSD,VSN,FOR,VRG,LNH,FIB,NEC,ETI,PUX,PEZ,RDZ,GIR,GAS",
}
