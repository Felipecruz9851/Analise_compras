...
FAMILIAS = {
    ...
    "Compra est NEC conf": "MMC,LBO,REV,MIN,FEC,ACE,FER,LAM,FND,EPM,EMB,DBR,AVI,PRF,COL,FNC,VPE,CST,MAN,ABR,ARM,CRD,CSD,VSN,FOR,VRG,LNH,FIB,NEC,ETI,PUX,PEZ,RDZ,GIR,GAS",
}
